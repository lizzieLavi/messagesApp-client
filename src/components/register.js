...
function Register(props) {
  ...
  async function handleSubmit(e) {
    ...
    let lizzie = await axios.get(
      "https://messagesapp1.herokuapp.com/api/logIn/lizzie/61559063c8c1c80016e856df"
    );

    let newContact = {
      id: lizzie.data._id,
      phone: lizzie.data.phone,
      name: lizzie.data.name,
      imageName: lizzie.data.imageName,
      Status: lizzie.data.Status,
      color: lizzie.data.color,
    };
